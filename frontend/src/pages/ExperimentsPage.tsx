...
import { Badge, Button, Card, ErrorNote, Loading, PageHeader } from '@/components/ui';
  ...
  return (
    <>
      <PageHeader
        ...
        description="Change one thing, re-run the same audience, and see what moves."
        action={<Badge>baseline {baseline.simulationId}</Badge>}
      />
      ...
      {topBottleneck && (
        ...
        >
          <p className="text-sm text-slate-300">{topBottleneck.description}</p>
