      ...
      <Card>
        ...
        <input
          ...
          className="block w-full text-sm text-slate-400 file:mr-4 file:rounded-lg file:border-0
                     file:bg-ink-600 file:px-4 file:py-2 file:text-sm file:text-slate-200
      ...
      {contentDna && (
        <div className="mt-6 space-y-4">
          ...
          <Card title="Content DNA" subtitle={contentDna.topic}>
            ...
            <blockquote className="mt-4 border-l-2 border-accent-dim pl-4 text-sm italic text-slate-300">
          ...
          <Button onClick={() => navigate('/simulate')}>Run simulation</Button>
        </div>
      )}
    </>
  );
